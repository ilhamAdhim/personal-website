...
in useQuery() by <span style={{textDecoration: 'underline'}}> [Tanstack Query](https://tanstack.com/query/latest)</span>.
...
/>
<Box m="1em 0" color="gray" textAlign="center">
  Many options to choose from. You might need to copy it from the  <span style={{ fontWeight: 'bold', textDecoration: 'underline' }}> [Github Repo](https://github.com/shadcn-ui/ui/tree/main/apps/www/app/(app)/examples) </span> though
</Box>
