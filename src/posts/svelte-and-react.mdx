...
<Box m="1em 0" textAlign="center">
  Photos from{" "}
  <u>
    [Unsplash](https://unsplash.com/@flowforfrank?utm_source=medium&utm_medium=referral){" "}
  </u>{" "}
</Box>
...
<img
  ...
  src="https://miro.medium.com/v2/resize:fit:786/format:webp/0*5a0G4z2c1tcjzHHQ.png   "
  alt="Jumbotron image by unsplash"
/>
<Box m="1em 0" textAlign="center">
  {" "}
  How common components are written in React vs. Svelte{" "}
</Box>
<br />
...
<img
  style={{ width: "100%", objectFit: "cover", backgroundPosition: "center" }}
  src="https://miro.medium.com/v2/resize:fit:786/format:webp/1*gX9y5rQRQ52eK4mT6TvMaA.png"
  alt="Svelte vs React browser DOM"
/>
<Box m="1em 0" textAlign="center">
  {" "}
  The approach used by React and Svelte to render a dynamic web page{" "}
</Box>
...
<img
  style={{ width: "100%", objectFit: "cover", backgroundPosition: "center" }}
  src="https://miro.medium.com/v2/resize:fit:640/format:webp/1*cdtlWcBEC2Q1YJg_f8_jNQ.png"
  alt="Svelte vs React browser DOM"
/>
<Box m="1em 0" textAlign="center">
  {" "}
  Build size comparison with same app and same features for React and Svelte{" "}
</Box>
...
<img
  style={{ width: "100%", objectFit: "cover", backgroundPosition: "center" }}
  src="https://miro.medium.com/v2/resize:fit:786/0*HE2o4_3GyS3wRamZ"
  alt="Svelte vs React browser DOM"
/>
<Box m="1em 0" textAlign="center">
  {" "}
  Lighthouse checking — Svelte App{" "}
</Box>

<br />
<img
  style={{ width: "100%", objectFit: "cover", backgroundPosition: "center" }}
  src="https://miro.medium.com/v2/resize:fit:786/0*3_q_4JG9GWwHYWhm"
  alt="Svelte vs React browser DOM"
/>
<Box m="1em 0" textAlign="center">
  {" "}
  Lighthouse checking — React App{" "}
</Box>

<br />
<Alert status="success" variant="left-accent">
  Note: The result may vary in different devices and each test. In my case
  however, it is consistent that Svelte performance is way better than React.
</Alert>
<br />
...
<br />
While React has a more established and abundant environment to work with, Svelte
has its own thriving community. Below are some references for UI Framework for Svelte:
<br />

<ul>
  <li>
    {" "}
    <u> [Svelte UI](https://www.svelteui.org/) </u>{" "}
  </li>
  <li>
    {" "}
    <u>
      {" "}
      [Attractions](https://illright.github.io/attractions/?ref=madewithsvelte.com){" "}
    </u>{" "}
  </li>
  <li>
    {" "}
    <u> [Smelte](https://smeltejs.com/) </u>{" "}
  </li>
  <li>
    {" "}
    <u> [Svelte Atoms](https://svelte-atoms.web.app/) </u>{" "}
  </li>
  <li>
    {" "}
    <u> [Svelma](https://c0bra.github.io/svelma/) </u>{" "}
  </li>
  <li>
    {" "}
    <u> [SvelteStrap](https://sveltestrap.js.org/) </u>{" "}
  </li>
</ul>
...
<ul>
  <li>
    {" "}
    <u> [Svelte App](https://github.com/ilhamAdhim/mylib-svelte) </u>{" "}
  </li>
  <li>
    {" "}
    <u> [React App](https://github.com/ilhamAdhim/mylib-react) </u>{" "}
  </li>
</ul>
